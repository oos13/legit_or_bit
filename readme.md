...
## Folder Contents 📁
 ...
 - `fin_script_create.py`- Contains all fact checking API calls, data-frame operations for saving query info, and user formatted returns. Used to run and check API responces
